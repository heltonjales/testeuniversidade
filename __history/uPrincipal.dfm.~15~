object frmPrincipal: TfrmPrincipal
  ...
  object MainMenu1: TMainMenu
    ...
    object Pedaggico1: TMenuItem
      Caption = 'Turmas'
      object Matriculas1: TMenuItem
        Caption = 'Matriculas de Alunos'
        OnClick = Matriculas1Click
      end
      object urmas1: TMenuItem
        Caption = 'Professores x Disciplinas'
        OnClick = urmas1Click
      end
      object LanamentodeNotas1: TMenuItem
        Caption = 'Lan'#231'amento de Notas'
        OnClick = LanamentodeNotas1Click
      end
    end
    object Relatrios1: TMenuItem
      ...
      object AlunoseProfessores1: TMenuItem
        Caption = 'Alunos e Professores'
        OnClick = AlunoseProfessores1Click
      end
    end
